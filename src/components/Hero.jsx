      ...
      <Container maxW={"6xl"}>
        ...
        >
          <Flex alignItems={"center"} flexDir={"column"} gap={4} maxW={"4xl"}>
            ...
            <TypingEffect   textAlign={"center"}
              lineHeight={2}
              fontSize={"22px"}
              my={2}
              color={"gray.300"} strings={[`Need a budget-friendly, cross-platform mobile app and website using React Native, Expo, and modern web technologies? You’re in the right place.`]}/>
