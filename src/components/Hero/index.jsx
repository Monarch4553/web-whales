      ...
      <Container my={'auto'} maxW={"6xl"}>
        ...
        >
          <Flex alignItems={"center"} flexDir={"column"} gap={4} maxW={"4xl"}>
            ...
            <TypingEffect color={'whiteAlpha.600'} textAlign={'center'}
              strings={[
                "Need a budget-friendly, cross-platform mobile app and website using React Native, Expo, and modern web technologies? ^500 You’re in the right place.",
              ]}
            ></TypingEffect>
